...
**Prerequisites:**
- Phase 2 PurpleVoice loop deployed (Plans 02-01, 02-02, 02-03 complete)
...
9. Press the hotkey again — PurpleVoice should now work normally.
...
- No notification appears → check exit-code dispatcher in purplevoice-lua/init.lua for the exit 10 case; verify bash glue is exiting 10 (not 12) by capturing the actual sox stderr first time you reset (see also Plan 02-01 stderr-capture task).
