...
- [ ] **DST-04**: `hyperfine` benchmark on the install machine produces p50 / p95 latency numbers for short, medium, and long utterances — gates the v1.1 warm-process upgrade decision. **Plan 03-03 Wave 3 harness + reference WAVs + BENCHMARK.md template all committed 2026-05-04** (commits e934486 / 8f60937 / 3a1a7b8 / 645323d); Task 3-5 live walkthrough DEFERRED 2026-05-04 by Oliver — no time pressure, run later. Resume recipe in `.planning/BACKLOG.md` item 2 + Plan 03-03 SUMMARY § Status. Phase 5 verdict stays "Conditional" until DST-04 lands.
...
| DST-04 | Phase 3: Distribution & Benchmarking + Public Install | Pending — DEFERRED 2026-05-04 (harness ready Plan 03-03 commits e934486..645323d; Task 3-5 walkthrough deferred per Oliver; BACKLOG#2) |
